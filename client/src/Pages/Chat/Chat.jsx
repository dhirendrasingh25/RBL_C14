                ...
                <Card className="h-full flex text-comp flex-col">
                    ...
                    <CardContent className="flex-grow p-0">
                        <ScrollArea className="h-[calc(100vh-300px)] p-4" ref={scrollAreaRef}>
                            {messages.map((msg, i) => (
                                <div key={i} className={`flex items-start mb-4 ${msg?.sender === "current_user@example.com" ? "justify-end" : "justify-start"}`}>
                                    ...
                                    <div className={`p-3 rounded-lg max-w-[70%] ${msg?.sender === "current_user@example.com" ? "bg-green-500 text-white" : "bg-zinc-100"}`}>
                                        {msg?.sender !== "current_user@example.com" && (
                    ...
                    <CardFooter>
                        <form onSubmit={handleSubmit} className="w-full flex space-x-2 items-center">
                            <Input
                                value={message}
